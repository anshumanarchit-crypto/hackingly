...
try:
    from proofmesh.dense_retrieval.models import SemanticChunk, ChunkRecord
    from proofmesh.dense_retrieval.embeddings import SemanticEmbedder
    from proofmesh.dense_retrieval.semantic_retriever import SemanticRetriever
except ImportError:
...
def retriever():
    ...
    return SemanticRetriever(embedder=embedder)  # type: ignore[arg-type]
